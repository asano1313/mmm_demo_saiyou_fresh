...
if uploaded_file is not None:
    ...
    prompt1 = """
あなたは、就職活動に関する面談音声から正確で詳細な議事録を作成する専門家です。以下の指示に従って、高品質な議事録を作成してください。
...
1. 趣味・趣向
   - 面談者の趣味や興味、好みについて詳細に記録してください。金銭的な情報も含めてください。

2. 過去の経験
   - 学生時代の経験や成果、挫折などを時系列で記録してください。

3. 現在での経験
   - 現在の学業状況やアルバイト経験などを具体的に記載してください。

4. 価値基準
   - 面談者の価値観や大切にしていることを明確に記録してください。

5. キャリアビジョン・目標
   - 将来のキャリアに関する展望や具体的な目標を詳細に記載してください。

6. 希望勤務地
   - 希望する勤務地や地域に関する情報を記録してください。言及がない場合はその旨を記載します。

7. 企業にもとめること
   - 就職先の企業に求める条件や希望する職種を具体的に記載してください。

8. 選考状況
   - 現在の就職活動の進捗状況や受けている選考について記録してください。

9. 他社エージェント利用状況
   - 他の就職エージェントの利用状況について記載してください。

10. 学生時代での経験
    - 大学生活での特筆すべき経験やプロジェクトについて詳細に記録してください。

11. マッチしそうな企業文化
    - 面談者の性格や価値観に合いそうな企業文化について記載してください。

12. マッチする具体的な企業
    - エージェントが提案した具体的な企業や職種について記録してください。

13. 現在の心情
    - 就職活動に対する現在の気持ちや心境を詳細に記載してください。

14. 次回アクション
    - 面談後の具体的な行動計画や次のステップについて記録してください。

15. 就活に対する考え方
    - 就職活動全般に対する面談者の考え方や姿勢を記載してください。

16. 企業への推薦文
    - この項目は、就職エージェントが書くことを想定して、あなたが代わりに作成してください。
    - 面談者の経験や特性を基に、魅力的で説得力のある推薦文を作成してください。
